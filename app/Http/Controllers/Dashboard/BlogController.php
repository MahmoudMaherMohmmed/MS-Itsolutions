...
class BlogController extends Controller
{
    ...
    public function store(StoreBlogRequest $request)
    {
        ...
        return redirect()->route('blogs.show', $blog)->with('success', trans('blogs.messages.created'));
    }
    ...
    public function update(UpdateBlogRequest $request, Blog $blog)
    {
        ...
        return redirect()->route('blogs.show', $blog)->with('success', trans('blogs.messages.updated'));
    }
