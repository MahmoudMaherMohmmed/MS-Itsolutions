...
class SliderController extends Controller
{
    ...
    public function store(StoreSliderRequest $request)
    {
        ...
        return redirect()->route('sliders.show', $slider)->with('success', trans('sliders.messages.created'));
    }
    ...
    public function update(UpdateSliderRequest $request, Slider $slider)
    {
        ...
        return redirect()->route('sliders.show', $slider)->with('success', trans('sliders.messages.updated'));
    }
