...
class ServiceController extends Controller
{
    ...
    public function store(StoreServiceRequest $request)
    {
        ...
        return redirect()->route('services.show', $service)->with('success', trans('services.messages.created'));
    }
    ...
    public function update(UpdateServiceRequest $request, Service $service)
    {
        ...
        return redirect()->route('services.show', $service)->with('success', trans('services.messages.updated'));
    }
