...
class PartnerController extends Controller
{
    ...
    public function store(StorePartnerRequest $request)
    {
        ...
        return redirect()->route('partners.show', $partner)->with('success', trans('partners.messages.created'));
    }
    ...
    public function update(UpdatePartnerRequest $request, Partner $partner)
    {
        ...
        return redirect()->route('partners.show', $partner)->with('success', trans('partners.messages.updated'));
    }
